...
export const JSDELIVR_BASE_URL = "https://cdn.jsdelivr.net/gh/SibineshwaranS/julyten@main/src/assets/";

/**
 * Resolves the URL of an asset, preferring Cloudinary/CDNs with f_auto,q_auto.
...
export function getAssetUrl(localAsset, assetPath) {
  // 1. Optimize video with Cloudinary streaming
